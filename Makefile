...
publish:
	...
	cp figures/forecasts/forecast_*_2020_2035.png figures/publish/
	cp figures/training_fits/training_fit_*_1995_2025.png figures/publish/
	@echo ""
